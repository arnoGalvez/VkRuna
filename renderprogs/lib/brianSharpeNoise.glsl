#ifndef _BRIAN_SHARPE_NOISE_LIB
#define _BRIAN_SHARPE_NOISE_LIB
...
vec4 NoiseHarmonicsPerlin(vec3 pos, float a, float f, int octaves, float persistence, float lacunarity)
{
    vec4 ret = vec4(0.0);
    float aTot = 0.0;
    ...
    return vec4(ret.yzw, ret.x) /* / aTot */;
}
